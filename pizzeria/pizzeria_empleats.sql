...
CREATE TABLE `empleats` (
  ...
  `botiga` int DEFAULT NULL,
  `cuiner_repartidor` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`empleat_id`),
  KEY `botiga` (`botiga`),
  CONSTRAINT `empleats_ibfk_1` FOREIGN KEY (`botiga`) REFERENCES `botigues` (`botiga_id`) ON DELETE CASCADE
...
-- Dump completed on 2023-04-27 18:10:04
